    ...
    >
      <div className="pt-5 space-y-3 h-full  bg-white rounded-t-2xl w-full flex flex-col items-center">
        ...
        <div className="px-4 pt-4 bg-white rounded-lg space-y-5 w-full">
          ...
          >
            {isEventLoading ? (
              <div className="flex h-full justify-center items-center text-rgtpink">
        ...
        <div className="px-4 bg-white rounded-lg space-y-2 w-full">
          ...
          <div
            className={`flex flex-col ${
              isEventLoading ? "" : "md:grid grid-cols-2 gap-2"
            }  transition-all duration-300 ease-in max-h-[400px] ${
          ...
          >
            {isEventLoading ? (
              <div className="flex h-full justify-center w-full items-center text-rgtpink">
                <Loader className="animate-spin" />
              </div>
