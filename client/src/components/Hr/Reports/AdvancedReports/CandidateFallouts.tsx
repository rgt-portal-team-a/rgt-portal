...
export const CandidateFallouts = () => {
  ...
  const candidates = recruitmentsData?.recruitments || []
  // const candidates = [
  //   {
  //     id: 1,
        ...
        {currentCandidates.map((candidate) => (
          ...
          >
            ...
            <div className="text-left flex items-center p-2 bg-[#E328AF] rounded-lg">
              <div>
                <div className="text-sm">DropOff Stage:</div>
                <div className="font-bold">
                  {candidate.predictedDropOffStage}
                </div>
              </div>
                ...
                <div
                  ...
                  style={{
                    background: `conic-gradient(
                      #4CAF50 ${candidate.predictedDropOff}%, 
                      #e0e0e0 ${candidate.predictedDropOff}%
                    )`,
                    borderRadius: "50%",
                  }}
                >
